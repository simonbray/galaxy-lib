...
ENTRY_POINTS = '''
        ...
        mulled-update-singularity-containers=galaxy.tools.deps.mulled.mulled_update_singularity_containers:main
        mulled-list=galaxy.tools.deps.mulled.mulled_list:main
